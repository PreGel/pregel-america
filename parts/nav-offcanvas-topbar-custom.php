								...
								<ul id="menu-main-left-1" class="dropdown menu float-left" data-dropdown-menu="">
									...
									<li>
										...
										<ul class="menu arrow-box submenu is-dropdown-submenu first-sub vertical" data-submenu="" aria-hidden="true" role="menu">
											...
											<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel-itc.com/training/5-star-pastry-series/">5-Star Pastry Series</a></li>
											...
											<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel-itc.com/training/five-star-ambassadors/">5-Star Pastry Ambassadors</a></li>
											<li class="menu-item menu-item-type-post_type menu-item-object-page is-submenu-item is-dropdown-submenu-item" role="menuitem"><a href="https://pregel-itc.com/training/5-star-sponsors/">5-Star Pastry Series® Sponsors</a></li>
