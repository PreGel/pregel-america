			...
			<div id="pg-locations-section">
				...
				<div class="grid-x" id="pg-about-content-row">
					...
					<div id="location-links" class="small-12 medium-12 large-12 cell">
					 <div class="grid-x">
					  <div class="large-6 medium-6 text-left cell">
						<h4><a href="https://www.pregel.com" target="_blank">PreGel</a></h4>
					  </div>
					  <div class="large-6 medium-6 text-left cell">
						<ul class="locations-social">
							<li>
					...
					<div id="location-links" class="small-12 medium-12 large-12 cell">
		          	<div class="grid-x">
		          		<div class="large-6 medium-6 text-left cell">
		          			<h4><a href="https://www.pregelgreece.com" target="_blank">PreGel Greece ΕΠΕ</a></h4>
		          		</div>
		          		<div class="large-6 medium-6 text-left cell">
		          			<ul class="locations-social">
		          				<li>
				...
				<div class="grid-x" id="pg-about-content-row">
				    <div id="region-title" class="small-12 large-12 cell">
						...
						<div id="location-links" class="small-12 medium-12 large-12 cell">
						 <div class="grid-x">
						  <div class="large-6 medium-6 text-left cell">
							<h4><a href="https://pregel-asia.com/" target="_blank">PreGel Asia</a></h4>
						  </div>
						  <div class="large-6 medium-6 text-left cell">
							<ul class="locations-social">
								<li>
